...
Route::group(['module' => 'appearance', 'namespace' => 'Phambinh\Appearance\Http\Controllers\Admin', 'middleware' => ['web'], 'prefix' => 'admin/appearance'], function () {
    ...
    Route::put('menu-item/{menu_item}', 'MenuController@menuItemUpdate')->name('admin.appearance.menu-item.update')->middleware('can:admin.appearance.menu.item.edit,menu_item');
    Route::delete('menu-item/{menu_item}', 'MenuController@menuItemDestroy')->name('admin.appearance.menu-item.destroy')->middleware('can:admin.appearance.menu.item.destroy,menu_item');
